...
class Model:
    ...
    def build_model(self, dataset, nb_classes = 2):
        ...
        self.model.add(Dropout(0.25))                                       #6 Dropout层dropout是CNN中防止过拟合提高效果的一个大杀器
        ...
        self.model.add(Flatten())                                           #13 Flatten层--Flatten层用来将输入“压平”，
                                                                            #即把多维的输入一维化，常用在从卷积层到全连接层的过渡
